...
const { uploadImage } = operatingApi.serviceApi
...
export default {
  ...
  methods: {
    ...
    handleSubmit(refName) {
      ...
      // /\<img[\s]/g, '<img style="width:80%" '
      this.formAdd.cont = this.formAdd.cont.replace(/<img[\s]/g, '<img style="width: 90%;display: block; margin: 0 auto;" ')
    ...
    handleUpLoadChange(file) {
      ...
      reader.onload = () => {
        this.formAdd.base64String = reader.result.replace(/^data:image\/\w+;base64,/, "")
      }
