    ...
    >
      ...
      >
        ...
        <el-form-item label="类型">
          <el-radio-group v-model="formAdd.contTypeName">
        ...
        <el-form-item label="标签" :label-width="formLabelWidth" size="small">
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
          prop="cont"
          v-show="formAdd.contTypeName === '0'"
        >
          <vue-editor v-model="formAdd.cont"> </vue-editor>
        </el-form-item>
        <el-row>
          <el-col :span="12">
            <el-form-item label="地区" label-width="100px" prop="cityCodg">
              <el-cascader
                :options="cityList"
                :props="cascaderProps"
        ...
        <el-form-item label="封面" prop="ttlImgUrl">
          <el-upload
            class="upload-demo"
            action="#"
            multiple
  ...
  data() {
    return {
      ...
      formAddRule: {
        ...
        jumpUrl: [
          { required: false, message: "请输入外链地址", trigger: "blur" }
        ],
        printId: [
  ...
  methods: {
    ...
    async handleDelete(value) {
      ...
      try {
        ...
        await this._deleteCmsCont(contId)
      } catch (error) {
        this.$message({
          type: "info",
          message: "已取消"
